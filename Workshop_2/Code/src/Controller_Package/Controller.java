...
public class Controller {
        ...
        public void createDatabase() {
            try {
                String str = "[]";
                FileWriter fileWriter2 = new FileWriter("../DataBase.json");//Select the name of the file and the location
                fileWriter2.write(str); //Writes the file with the database
                fileWriter2.close();//Close the FileWriter
            }catch(IOException f){
                f.printStackTrace();
            }
